...
namespace _1.DAL.ConText
{
    public class DUAN1DBContext : DbContext
    {
        ...
        {
            dbContextOptionsBuilder.UseSqlServer(@"Data Source=JANG-NGUYEN\SQLEXPRESS;Initial Catalog=databaseDA001;Persist Security Info=True;User ID=giang_PH24594;Password=123");
        }
